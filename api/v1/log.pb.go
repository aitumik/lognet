...
func (x *Recorde) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Recorde) ProtoMessage() {}

func (x *Recorde) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_log_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use Recorde.ProtoReflect.Descriptor instead.
func (*Recorde) Descriptor() ([]byte, []int) {
	return file_api_v1_log_proto_rawDescGZIP(), []int{0}
}

func (x *Recorde) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *Recorde) GetOffset() uint64 {
	if x != nil {
		return x.Offset
	}
	return 0
...
var file_api_v1_log_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x06, 0x6c, 0x6f, 0x67, 0x2e, 0x76, 0x31, 0x22, 0x37, 0x0a, 0x07, 0x52, 0x65,
	0x63, 0x6f, 0x72, 0x64, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x01,
	...
	0x73, 0x65, 0x74, 0x42, 0x1f, 0x5a, 0x1d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x61, 0x69, 0x74, 0x75, 0x6d, 0x69, 0x6b, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x6c, 0x6f,
